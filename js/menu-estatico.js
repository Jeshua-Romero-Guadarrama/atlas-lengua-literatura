...
(function () {
  ...
  var SECCIONES = [
    { ruta: "temario", nombre: "Temario" },
    { ruta: "analizador", nombre: "Analizador" },
    { ruta: "conjugador", nombre: "Conjugador" },
    { ruta: "juegos", nombre: "Juegos" },
    { ruta: "figuras", nombre: "Figuras" },
    { ruta: "ortografia", nombre: "Ortografía" },
    { ruta: "literatura", nombre: "Literatura" },
