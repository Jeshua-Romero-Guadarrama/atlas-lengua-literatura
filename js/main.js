 ...
 * Solo se intenta bajo HTTPS o en localhost, dado que abrir index.html con doble clic usa el protocolo de archivo y ahí el registro falla con un error ruidoso que no aporta nada.
...
if ("serviceWorker" in navigator &&
  ...
  window.addEventListener("load", () => {
    navigator.serviceWorker.register("sw.js").catch(() => { /* sin soporte */ });
  });
}

/* La instancia queda en window.atlas para poder inspeccionarla desde la consola del navegador */
window.atlas = new Aplicacion();
window.atlas.iniciar().catch((err) => {
