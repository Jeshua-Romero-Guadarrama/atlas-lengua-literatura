/* ============================================================
   ...
   acción y el estado activo son siempre los del documento.
   ============================================================ */
...
export class MenuLateral {
  ...
  /* La altura se mide una vez y se rehace al cambiar el tamaño de la
     ventana, para no provocar un recálculo de geometría en cada paso
     del desplazamiento. */
  medir() {
  ...
  /* Umbral con histéresis: La cabecera se retira pasada su altura más un
     margen y solo regresa cerca del principio. La separación entre ambos
     valores evita que el cambio parpadee cuando el lector se detiene justo
  ...
  /* El panel se reconstruye en cada apertura leyendo las pestañas reales
     del documento. Así respeta las que el arranque ocultó por falta de
     contenido y refleja la activa, sin mantener listas escritas a mano. */
  construir() {
